...
if returns:
    filtered_df = filtered_df[filtered_df["Returns"].isin(returns)]
...
with st.expander("View Data of TimeSeries:"):
    ...
    '''xlsx = linechart.to_excel("output.xlsx", index=False)
    st.download_button('Download Data', data = xlsx, file_name = "TimeSeries.xlsx", mime ='text/xlsx')'''
